...
{{view('front.layout.header',['title'=>trans('main.home')])}}
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <a href="{{url('news?category_id='.$news1['cat_id'].'&id='.$news1['id'])}}" class="text-body-emphasis fw-bold icon-link gap-1 icon-link-hover stretched-link">
            {{trans('main.readmore')}}
        ...
        <?php 
          ...
          }elseif(!empty($news1['cat_icon'])){
            $img =url('storage/'.$news1['cat_icon']);
          }else{
            $img=url('assets/images/icon.png');
          }
          
          ?>
          <img src="{{$img}}" class="bd-placeholder-img" width="200" height="250" alt="">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <a href="{{url('news?category_id='.$news2['cat_id'].'&id='.$news2['id'])}}" class="text-body-emphasis fw-bold icon-link gap-1 icon-link-hover stretched-link">
            {{trans('main.readmore')}}
            <svg class="bi"><use xlink:href="#chevron-right"/></svg>
        ...
        <?php 
          ...
          }elseif(!empty($news2['cat_icon'])){
            $img =url('storage/'.$news2['cat_icon']);
          }else{
            $img=url('assets/images/icon.png');
          }
        ...
        <div>
          ...
          <ul class="list-unstyled">
            ...
            <li>
              ...
              ?>
              <img src="{{$img}}" class="bd-placeholder-img" width="100%" height="96" alt="">
                        <div class="col-lg-8">
