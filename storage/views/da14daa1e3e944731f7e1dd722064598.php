    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <a href="<?php echo url('news?category_id='.$news1['cat_id'].'&id='.$news1['id']); ?>" class="text-body-emphasis fw-bold icon-link gap-1 icon-link-hover stretched-link">
            <?php echo trans('main.readmore'); ?>
        ...
        <?php 
          ...
          ?>
          <img src="<?php echo $img; ?>" class="bd-placeholder-img" width="200" height="250" alt="">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <a href="<?php echo url('news?category_id='.$news2['cat_id'].'&id='.$news2['id']); ?>" class="text-body-emphasis fw-bold icon-link gap-1 icon-link-hover stretched-link">
            <?php echo trans('main.readmore'); ?>
            <svg class="bi"><use xlink:href="#chevron-right"/></svg>
        ...
        <div>
          ...
          <ul class="list-unstyled">
            ...
            <li>
              ...
              ?>
              <img src="<?php echo $img; ?>" class="bd-placeholder-img" width="100%" height="96" alt="">
                        <div class="col-lg-8">
