...
<form action="<?php echo aurl('news/edit?id='.$news['id']); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            <select name="category_id" id="category_id" class="form-select <?php echo  !empty(get_error('category_id'))?'is-invalid':''; ?>">
        ...
        <div class="col-md-12">
            ...
            <textarea name="description" id="description" placeholder="<?php echo trans('news.description'); ?>"
