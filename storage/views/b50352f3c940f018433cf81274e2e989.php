...
<html lang="<?php echo $lang ?>" 
 ...
 data-bs-theme="auto">
  <head><script src="<?php echo url('assets/admin'); ?>/assets/js/color-modes.js"></script>
    ...
    <title><?php echo  trans('admin.signup') ; ?></title>
...
<?php if(session_has('error_signup')): ?> 
   <div class="alert alert-danger">
    <?php echo session_flash('error_signup'); ?>
    </div>
...
<form action="<?php echo url('users/signup/add'); ?>" method="post" enctype="multipart/form-data">
